                    ...
                    <AnimatePresence>
                        {isOpen && (
                            ...
                            >
                                ...
                                <div className="text-[10px] bg-white px-6 py-1 opacity-40">v220 (Platform Fix)</div>
                                ...
                                {messages.map((m, i) => (
                                    <div key={i} className={`flex flex-col ${m.role === 'user' ? 'items-end' : 'items-start'} space-y-2`}>
                                        ...
                                        {(m.role === 'bot' && (m.text.toLowerCase().includes('botão') || m.text.toLowerCase().includes('finalizarmos'))) && (
                                            <a 
