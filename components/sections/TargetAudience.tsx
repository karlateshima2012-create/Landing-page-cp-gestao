    ...
    return (
        <section id="solucoes" className="py-20 md:py-32 bg-slate-950 relative overflow-hidden w-full">
            ...
            <div className="max-w-[1440px] mx-auto relative z-10 px-4 md:px-8 lg:px-12">
                <div className="w-full bg-slate-900/40 border-2 border-brand-blue/60 rounded-[2rem] md:rounded-[4rem] py-16 md:py-24 px-6 md:px-12 lg:px-12 backdrop-blur-3xl shadow-[0_80px_160px_-40px_rgba(0,0,0,0.95)] relative overflow-hidden group/main">
