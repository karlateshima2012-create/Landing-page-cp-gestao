    ...
    return (
        <section id="solucoes" className="py-32 bg-slate-950 relative overflow-hidden w-full">
            ...
            <div className="max-w-[1440px] mx-auto px-6 relative z-10">
                <div className="bg-slate-900/40 border-2 border-brand-blue/60 rounded-[4rem] py-24 px-8 md:px-16 backdrop-blur-3xl shadow-[0_80px_160px_-40px_rgba(0,0,0,0.95)] relative overflow-hidden group/main">
