                ...
                <div className="w-full bg-slate-900/40 border-2 border-brand-blue/60 rounded-[2rem] md:rounded-[4rem] py-16 md:py-24 px-6 md:px-12 lg:px-20 backdrop-blur-3xl shadow-[0_80px_160px_-40px_rgba(0,0,0,0.95)] relative overflow-hidden group/main">
                    ...
                    <div className="relative z-10 max-w-5xl mx-auto">
                        <div className="text-center mb-8">
                            <h2 className="text-3xl md:text-5xl font-black text-white mt-4 mb-6 tracking-tighter leading-tight">
                                O que é <span className="text-brand-blue text-glow-blue">CP Gestão?</span>
                            </h2>
                            
                            <p className="text-lg md:text-2xl text-brand-gray/90 font-light leading-relaxed max-w-4xl mx-auto mb-2">
                                CP Gestão é a plataforma que transforma clientes ocasionais em clientes fiéis. 
                            </p>
                            <p className="text-lg md:text-2xl text-white font-light leading-relaxed max-w-4xl mx-auto">
                                Dois sistemas em um: CRM + Programa de Fidelidade integrados.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8">
                            <div className="bg-slate-950/60 border border-white/10 p-8 md:p-10 rounded-[2.5rem] backdrop-blur-xl group hover:border-brand-blue/40 transition-all duration-500 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-lg md:text-2xl font-black text-white mb-4 uppercase tracking-tight text-center">CRM SIMPLES E PODEROSO</h3>
                            ...
                            <div className="bg-slate-950/60 border border-white/10 p-8 md:p-10 rounded-[2.5rem] backdrop-blur-xl group hover:border-brand-pink/40 transition-all duration-500 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-lg md:text-2xl font-black text-white mb-4 uppercase tracking-tight text-center">PROGRAMA DE FIDELIDADE COM PONTOS</h3>
                                <p className="text-brand-gray/80 text-lg font-light leading-relaxed">
                        ...
                        <div className="text-center relative pt-8">
                            ...
                            <a
                                href="#pricing"
                                className="inline-flex items-center justify-center relative h-12 px-10 bg-white text-slate-950 font-black text-xs uppercase tracking-wider hover:scale-105 active:scale-95 transition-all shadow-[0_0_25px_rgba(56,182,255,0.35)] hover:shadow-brand-blue/40 group overflow-hidden rounded-lg"
                                onClick={(e) => {
                                    e.preventDefault();
