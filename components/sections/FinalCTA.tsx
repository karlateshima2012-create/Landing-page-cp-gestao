...
export const FinalCTA = () => (
    <section className="py-20 md:py-32 bg-transparent px-4 md:px-8 lg:px-12 relative text-center w-full">
        ...
        <div className="max-w-[1440px] mx-auto relative z-10 bg-slate-950/95 border border-white/10 border-b-0 rounded-[2rem] md:rounded-[3rem] py-16 md:py-24 px-6 md:px-12 lg:px-12 backdrop-blur-3xl shadow-[0_50px_200px_-50px_rgba(0,0,0,1),0_0_80px_-20px_rgba(56,182,255,0.15)] overflow-hidden transition-all duration-500">
            <Starfield />
            {/* Internal Card Glow */}
