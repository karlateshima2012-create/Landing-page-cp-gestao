            ...
            <div className="max-w-7xl mx-auto flex flex-col items-start gap-8">
                ...
                <div className="w-full flex items-center justify-between gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-brand-blue/10 backdrop-blur-md hover:bg-brand-blue/20 border border-brand-blue/20 px-2.5 py-1 rounded-full transition-all group shrink-0"
                    >
                        <ArrowUp className="w-3 h-3 text-brand-blue transition-transform group-hover:-translate-y-0.5" />
                        <span className="text-[8px] font-black uppercase tracking-[0.1em] text-brand-blue/80 group-hover:text-brand-blue">topo</span>
                    </button>
                </div>
                ...
                <div className="w-full pt-4 border-t border-white/5">
                    <p className="text-slate-500 text-[7px] sm:text-[9px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] whitespace-nowrap overflow-hidden text-ellipsis">
