                ...
                <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                        ...
                        <div className="flex items-center gap-6 md:border-l md:border-white/10 md:pl-8">
                            ...
                            >
                                <ArrowUp className="w-7 h-7 text-brand-blue group-hover:scale-110 transition-transform" />
                                <span className="text-[8px] font-black uppercase tracking-[0.2em] text-brand-blue/60 group-hover:text-brand-blue mt-1">voltar</span>
                            </button>
                    ...
                    {/* Navigation */}
                    <div className="overflow-x-auto w-full lg:w-auto py-4">
