                ...
                <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                        ...
                        <div className="flex flex-col items-center md:items-start gap-3">
                            ...
                            {/* Back to Top - Glassmorphism Oval */}
                            <button
                        ...
                        {/* Pipe & Socials - Tight spacing */}
                        <div className="flex items-center gap-4 md:border-l md:border-white/10 md:pl-4">
                            <div className="flex gap-4">
                                <a href="https://www.instagram.com/creativeprint.jp/" target="_blank" rel="noopener noreferrer" className="text-brand-gray/60 hover:text-brand-pink transition-all hover:scale-110">
                                ...
                                <a href="https://www.facebook.com/profile.php?id=61580038140386" target="_blank" rel="noopener noreferrer" className="text-brand-gray/60 hover:text-brand-blue transition-all hover:scale-110">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                                </a>
                                <a href="https://wa.me/8109011886491" target="_blank" rel="noopener noreferrer" className="text-brand-gray/60 hover:text-brand-yellow transition-all hover:scale-110">
                    ...
                    {/* Navigation - Horizontal flex row */}
