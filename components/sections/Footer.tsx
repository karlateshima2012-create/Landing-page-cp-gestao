            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center gap-10">
                ...
                <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                        ...
                        <div className="flex gap-4 md:border-l md:border-white/10 md:pl-4">
                    ...
                    {/* Navigation */}
                    <ul className="flex flex-wrap justify-center items-center gap-x-5 md:gap-x-8 text-brand-gray text-[11px] font-black uppercase tracking-[0.2em]">
                        <li><a href="#solucoes" className="hover:text-white transition-colors">Solução</a></li>
                        <li className="text-brand-blue/60 select-none text-lg">•</li>
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 group text-brand-blue hover:text-white transition-all underline underline-offset-8 decoration-brand-blue/30 hover:decoration-white"
                    >
                        <ArrowUp className="w-6 h-6 transition-transform group-hover:-translate-y-1" />
                        <span className="text-[11px] font-black uppercase tracking-[0.2em]">Voltar ao Topo</span>
                    </button>
                </div>
